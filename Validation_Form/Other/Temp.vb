Sub BORIS_PCST()
  ...
  'Converts range to table.
    ...
    ActiveSheet.ListObjects("Unmapped_Table").Range.AutoFilter Field:=5,
    Criteria1:="<>"
  ...
  'Refresh UsedRange
    ...
    'Filters to remove blank lines.
    ActiveSheet.ListObjects("Clinical_Table").Range.AutoFilter Field:=5,
    Criteria1:="<>"
  ...
  tbl.Name = "Health_Maint_Table"
    ...
    With NewBook
        ...
        "C:\Users\" & User_Name & "\Documents\" & Project_Name & "_" & "PCST_Files\" & Source_Name, FileFormat:=
    ...
    'Sets selected cells as a table and names the table
        ...
        ActiveSheet.Range("Unmapped_Table[#All]").RemoveDuplicates Columns:=Array(7, 8
        ), Header:=xlYes
    ...
    'Applies sorting by Concept -> Measure -> Registry column
        ActiveWorkbook.Worksheets("Unmapped Codes").ListObjects("Unmapped_Table").sort.
        SortFields.Clear
        ActiveWorkbook.Worksheets("Unmapped Codes").ListObjects("Unmapped_Table").sort.
        SortFields.Add Key:=Range("Unmapped_Table[Concept]"), SortOn:=
        xlSortOnValues, Order:=xlAscending, DataOption:=xlSortNormal
        ActiveWorkbook.Worksheets("Unmapped Codes").ListObjects("Unmapped_Table").sort.
        SortFields.Add Key:=Range("Unmapped_Table[Measure]"), SortOn:=
        xlSortOnValues, Order:=xlAscending, DataOption:=xlSortNormal
        ActiveWorkbook.Worksheets("Unmapped Codes").ListObjects("Unmapped_Table").sort.
        SortFields.Add Key:=Range("Unmapped_Table[Registry]"), SortOn:=
        xlSortOnValues, Order:=xlAscending, DataOption:=xlSortNormal

        With ActiveWorkbook.Worksheets("Unmapped Codes").ListObjects("Unmapped_Table").
            sort
            .Header = xlYes
            .MatchCase = False
    ...
    tbl.Name = "Clinical_Table"
        ...
        ActiveSheet.Range("Clinical_Table[#All]").RemoveDuplicates Columns:=Array(5,
        10, 11), Header:=xlYes
    ...
    'Removes duplicates by source, nomenclature, and nomenclature ID
        ...
        ActiveWorkbook.Worksheets("Clinical Documentation").ListObjects(
        "Clinical_Table").Sort.SortFields.Clear
        ActiveWorkbook.Worksheets("Clinical Documentation").ListObjects(
        "Clinical_Table").Sort.SortFields.Add Key:=Range("Clinical_Table[Concept]"),
        SortOn:=xlSortOnValues, Order:=xlAscending, DataOption:=xlSortNormal
        ActiveWorkbook.Worksheets("Clinical Documentation").ListObjects(
        "Clinical_Table").Sort.SortFields.Add Key:=Range("Clinical_Table[Measure]"),
        SortOn:=xlSortOnValues, Order:=xlAscending, DataOption:=xlSortNormal
        ActiveWorkbook.Worksheets("Clinical Documentation").ListObjects(
        "Clinical_Table").Sort.SortFields.Add Key:=Range("Clinical_Table[Registry]") _
        , SortOn:=xlSortOnValues, Order:=xlAscending, DataOption:=xlSortNormal
        With ActiveWorkbook.Worksheets("Clinical Documentation").ListObjects(
            "Clinical_Table").Sort
            .Header = xlYes
            .MatchCase = False
            .Orientation = xlTopToBottom
    ...
    'Refresh UsedRange
        ...
        Application.CutCopyMode = False
        ActiveSheet.Range("Code_ID_Table[#All]").RemoveDuplicates Columns:=1, Header:=
        xlYes
    ...
    '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
        ...
        'Checks filtered table for visible data
                ...
                ActiveSheet.ListObjects("Unmapped_Table").Range.AutoFilter Field:=5,
                Criteria1:=Source_Name, Operator:=xlAnd
                ActiveSheet.ListObjects("Unmapped_Table").Range.AutoFilter Field:=12,
        ...
        'Checks table for visible data
                ...
                ActiveSheet.ListObjects("Health_Maint_Table").Range.AutoFilter Field:=11,
                Criteria1:=Source_Name, Operator:=xlAnd
        ...
        ActiveSheet.ListObjects("Clinical_Table").Range.AutoFilter Field:=5,
        Criteria1:=Source_Name, Operator:=xlAnd
        ActiveSheet.ListObjects("Clinical_Table").Range.AutoFilter Field:=15,
        Criteria1:="<>"
    ...
    'Checks filtered table for visible data.
      ...
      'Finds last row with text
            ...
            ActiveSheet.Range("$A$1:$O$" & LastRow).RemoveDuplicates Columns:=Array(4, 14, 15),
            Header:=xlYes
      ...
      'Creates the table
        ...
        Workbooks(Source_Name & ".xlsm").Close SaveChanges:=True
				'Switches back to old workbook to begin next loop
        Windows(Validation_File_Name).Activate
